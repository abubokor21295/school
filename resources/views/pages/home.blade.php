...
<div class="content-wrapper">
  <div class="row">
    <div class="col-sm-12 mb-4 mb-xl-0">
      ...
      <p class="font-weight-normal mb-2 text-muted" id="para1"></p>
    </div>
  </div>
  <div class="row mt-3">
    <div class="col-xl-3 flex-column d-flex grid-margin stretch-card">
      <div class="row flex-grow">
        <div class="col-sm-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Studernt Attendence</h4>
              ...
              <h2> <?php
                    ...
                    $attendeces = DB::Select("select count(admission_id)students from sch_attendences where date='$date'");
                    foreach ($attendeces as $attendece) {
                      echo $attendece->students;
                    };
        ...
        <div class="col-sm-12 stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <h4 class="text-dark font-weight-bold mb-2"><?php
                                                          $date = today();

                                                          $attendeces = DB::Select("select count(id)students from sch_admissions");
                                                          foreach ($attendeces as $attendece) {
                                                            echo $attendece->students;
                                                          };
