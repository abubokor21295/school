          ...
          <div class="card-body p-3">
            <div class="d-flex text-black">
              <div class="flex-shrink-0 me-3 h-80">
                <img src="{{asset('img')}}/<?php echo $user['photo'] ?>" alt="Generic placeholder image" class="img-fluid" style="width: 200px; border-radius: 10px;">
              </div>
                  ...
                  <div class="card mb-4">
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          <p class="text-muted mb-0"><?php echo $user['id'] ?></p>
                        </div>
                      </div>
                      <hr>
                      <div class="row">
